...
Comencemos viendo que hay en la secci<f3>n \ref{univariada} en la página \pageref{univariada}.

\clearpage



\section{Exploraci<f3>n Univariada}\label{univariada}
...
% Date and time: vie., jun. 29, 2018 - 3:04:23 p.m.
...
As<ed>, propongo que calculemos conglomerados de países usando toda la información de tres de los indicadores. Como nuestras variables son ordinales utilizaremos un proceso de conglomeración donde las distancia serán calculadas usando la medida {\bf gower} propuestas en \cite{gower_general_1971}, y para los enlazamientos usaremos la técnica de {\bf medoides} seg<fa>n \cite{reynolds_clustering_2006}. Los tres conglomerados se muestran en la Figura \ref{clustmap}.
...
\renewcommand{\refname}{Bibliograf<ed>a}
